                    ...
                    if (hex.building.resourcesIncome != null)
                    {
                        foreach (ResourceUnit resourceUnit in hex.building.resourcesIncome)
                        {
                            if (resourceUnit is UnitGold)
                                resourceBase.unitGold.AddValue((int)(resourceUnit.value * (double)(resourceBase.unitEnergy.limit / 100)));
                            if (resourceUnit is UnitIron)
                                resourceBase.unitIron.AddValue((int)(resourceUnit.value * (double)(resourceBase.unitEnergy.limit / 100)));
                            if (resourceUnit is UnitWood)
                                resourceBase.unitWood.AddValue((int)(resourceUnit.value * (double)(resourceBase.unitEnergy.limit / 100)));
                            if (resourceUnit is UnitFood)
                                resourceBase.unitFood.AddValue((int)(resourceUnit.value * (double)(resourceBase.unitEnergy.limit / 100)));
                        }
                    }
                }
            }
